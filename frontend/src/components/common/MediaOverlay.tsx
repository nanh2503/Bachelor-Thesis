...
import { FileItemInterface } from "./SelectAlbumDialog";
import { FavoriteFileList } from "../user/favorite";

const MediaOverlay = (props: { file: FileList | FileItemInterface | FavoriteFileList, media: Image | Video | FileItemInterface }) => {
